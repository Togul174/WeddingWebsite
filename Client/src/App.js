  ...
  return (
    <div className='main'>
      <div className="mainWelcomePage">
        ...
        <Footer ourDate="25 августа 2026 года" ourHappines="Будем рады разделить этот день с вами" />
        <DateCountdown />
      </div>
      <div className='mainDiscrPage'>
        <DearGuest dearGuest={<>Дорогие <br />родные и близкие!</>} />
        <RepeatText repeatText={<>Один день в этом году будет для нас особенным, и мы хотим разделить его с вами!<br />Приглашаем Вас на торжество, посвященное дню нашего бракосочетания, которое состоится:</>} />
        <RepeatText dateWed={<>25 августа 2026 года</>} />
        <SharedPhoto />
        ...
        <RepeatText titleRepeatText="Дресс-код" />
        <RepeatText repeatText={<>Дорогие дамы! <br /> Нам будет очень приятно, если вы поддержите стиль нашего торжества и выберете наряды в соответствии с цветовой палитрой:</>} />
        <Palette />
        <RepeatText repeatText={<>Дорогие мужчины! <br/> Просьба придерживаться классического стиля: <br/> белая рубашка и темные брюки/костюм.</>} />
        <RepeatText repeatText={<>Будем признательны, если образ "total white" будет только у невесты.</>} />
        <Timetable />
